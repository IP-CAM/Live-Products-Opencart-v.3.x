...
$_['entry_tab_general'] = 'Параметры';
$_['entry_tab_view'] = 'Отображение';
$_['entry_tab_style'] = 'Cтили';
...
$_['entry_calc_opt_qty'] = 'Пересчитывать по кол-ву (опции)';
$_['entry_show_sum_wgt'] = 'Показывать общий вес';
$_['entry_show_old_prc'] = 'Показывать старые цены';
$_['entry_show_opt_ful'] = 'Скрывать префиксы';
$_['entry_show_opt_pts'] = 'Показывать баллы опций';
$_['entry_show_opt_wgt'] = 'Показывать вес опций';
$_['entry_show_opt_qty'] = 'Показывать кол-во опций на складе';
$_['entry_show_opt_tip'] = 'Всплывающие подсказки';
$_['entry_text_delimiter'] = 'Разделитель';
...
$_['help_calc_opt_qty'] = 'Отображать параметры опций товара (цены, вес, баллы) в пересчете на указанное количество.';
$_['help_show_sum_wgt'] = 'Отображать общий вес товара включая указанные опции.';
$_['help_show_old_prc'] = 'При использовании дисконтов или акций отображать старые цены рядом с актуальными.';
$_['help_show_opt_ful'] = 'Показывать общую стоимость/баллы/вес опций и скрыть префиксы.';
$_['help_show_opt_pts'] = 'Отображать дополнительную стоимость опций в бонусных баллах.';
$_['help_show_opt_wgt'] = 'Отображать вес опций товара.';
$_['help_show_opt_qty'] = 'Отображать доступное количество опций товара.';
$_['help_show_opt_tip'] = 'Использовать всплывающие посказки для отображения веса, количества и баллов опций.';
$_['help_text_delimiter'] = 'Разделитель параметров опций: запятая, скобки, &bull;, &middot; и тд.';
$_['help_text_free'] = 'Текст для опций с нулевой стоимостью. Если не нужно - оставить поле пустым.';
$_['help_text_old'] = 'Текст для предыдущих(старых) цен опций (только для выпадающего списка).';
...
// Error text
$_['error_style'] = 'Заполните все наименования атрибутов!';
