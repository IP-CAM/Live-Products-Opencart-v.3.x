...
$_['entry_tab_general'] = 'Параметри';
$_['entry_tab_view'] = 'Відображення';
$_['entry_tab_style'] = 'Cтилі';
...
$_['entry_calc_opt_qty'] = 'Перераховувати за кількість (опції)';
$_['entry_show_sum_wgt'] = 'Показувати загальну вагу';
$_['entry_show_old_prc'] = 'Показувати старі ціни';
$_['entry_show_opt_ful'] = 'Приховувати префікси';
$_['entry_show_opt_pts'] = 'Показувати бали опцій';
$_['entry_show_opt_wgt'] = 'Показувати вагу опцій';
$_['entry_show_opt_qty'] = 'Показувати кіл-ть опцій в наявності';
$_['entry_show_opt_tip'] = 'Спливаючі підказки';
$_['entry_text_delimiter'] = 'Роздільник';
$_['entry_text_free'] = 'Безкоштовно';
$_['entry_text_old'] = 'Стара ціна';
...
$_['help_calc_opt_qty'] = 'Відображати параметри опцій товару (ціни, вага, бали) в перерахунку на зазначену кількість.';
$_['help_show_sum_wgt'] = 'Відображати загальну вагу товару та вказаних опцій.';
$_['help_show_old_prc'] = 'При використанні дисконтних або акційних цін показувати старі ціни поряд з актуальними.';
$_['help_show_opt_ful'] = 'Показувати загальну вартість/бали/вагу опцій та приховати префікси.';
$_['help_show_opt_pts'] = 'Відображати додаткові бали для опцій товару.';
$_['help_show_opt_wgt'] = 'Відображати вагу опцій товару.';
$_['help_show_opt_qty'] = 'Відображати доступну кількість для опцій товару.';
$_['help_show_opt_tip'] = 'Використовувати спливаючі підказки для відображення ваги, кількості, та балів опцій товару.';
$_['help_text_delimiter'] = 'Роздільник параметрів опцій товару: запята, скобки, &bull; тощо.';
...
// Error text
$_['error_style'] = 'Заповніть найменування атрибутів!';
